...
class IntegrationViewTests(unittest.TestCase):
    ...
    def _emptyURI_test(self):
        ...
        self.assertRaises(TypeError,self._call_view_to_test)
        self.assertTrue(int(response.headers.get('Content-Length')) < 500)
    ...
    def test_views_for_URIError(self):
        ...
        test_views=dict()
        test_views["AppEnsembleRequestViews"]=list()
        test_views["AppPoolRequestViews"]=list()

        test_views["AppEnsembleRequestViews"].append({'view': "page_details", 'ignore_test': []})
        test_views["AppEnsembleRequestViews"].append({'view': "page_visualize_bpm", 'ignore_test': []})
        test_views["AppEnsembleRequestViews"].append({'view': "page_get_bpmn", 'ignore_test': ["_tooMuchURI_butOK_test"]})
        test_views["AppEnsembleRequestViews"].append({'view': "page_get_ae_pkg", 'ignore_test': ["_tooMuchURI_butOK_test"]})

        test_views["AppPoolRequestViews"].append({'view': "page_details", 'ignore_test': ["_tooMuchURI_butOK_test","_wrongURI_test"]})
    ...
    def test_documentation_ap_pool_view(self):
        response = views.AppPoolBaseViews(self.context, self.request).page_overview()
    ...
    def test_ap_app_details_view(self):
        ...
        response = views.AppPoolRequestViews(self.context, self.request).page_details()
    ...
    def test_api_ap_json_view(self):
        response = views.AppPoolBaseViews(self.context, self.request).api_json()
    ...
    """def test_zz_action_update_app_pool_view(self):
        ...
        response = views.AppPoolBaseViews(self.context, self.request).action_update()
    ...
    def test_app_ensembles_view(self):
        response = views.AppEnsembleBaseViews(self.context, self.request).page_overview()
        self._standard_tests(response)
    ...
    def test_ae_details_view(self):
        ...
        response = views.AppEnsembleRequestViews(self.context, self.request).page_details()
    ...
    def test_ae_visualize_bpm_view(self):
        ...
        response = views.AppEnsembleRequestViews(self.context, self.request).page_visualize_bpm()
        self.assertEqual(response['ae_uri'], 'testAppEnsemble')
    ...
    def test_ae_get_bpmn_view(self):
        ...
        response = views.AppEnsembleRequestViews(self.context, self.request).page_get_bpmn()
        self.assertIsInstance(response,Response)
    ...
    def test_api_ae_json_view(self):
        response = views.AppEnsembleBaseViews(self.context, self.request).api_json()
    ...
    def test_ae_get_ae_pkg_view(self):
        ...
        response = views.AppEnsembleRequestViews(self.context, self.request).page_get_ae_pkg()
    ...
    def test_zz_action_update_app_ensembles_view(self):
        response = views.AppEnsembleBaseViews(self.context, self.request).action_update()
        self.assertIsInstance(response,Response)
